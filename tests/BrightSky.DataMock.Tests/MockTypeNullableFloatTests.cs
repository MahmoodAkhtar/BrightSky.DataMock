...
public class MockTypeNullableFloatTests
{
    ...
    {
        var actual = Dm.NullableFloats().NullableProbability(1);

        Assert.IsType<MockTypeNullableFloat>(actual);
    }
    
    [Fact]
    public void When_NullableFloatsNullableProbability_NullablePercentage_LessThanZero_Throws_ArgumentOutOfRangeException()
    {
        Action action = () => Dm.NullableFloats().NullableProbability(-1);

        Assert.Throws<ArgumentOutOfRangeException>(action);
    }
    
    [Fact]
    public void When_NullableFloatsNullableProbability_NullablePercentage_GreaterThanOneHundred_Throws_ArgumentOutOfRangeException()
    {
        Action action = () => Dm.NullableFloats().NullableProbability(101);
    ...
    {
        var actual = Dm.NullableFloats().NullableProbability(0).ToList();
    ...
    {
        var actual = Dm.NullableFloats().NullableProbability(100).ToList();
    ...
    public void When_NullableFloatsNullableProbabilityAndToList_With_NullablePercentage_And_Size_Returns_ExpectedNullCount(int nullablePercentage, int size)
    {
        ...
        var actual = Dm.NullableFloats().NullableProbability(nullablePercentage).ToList(size);
