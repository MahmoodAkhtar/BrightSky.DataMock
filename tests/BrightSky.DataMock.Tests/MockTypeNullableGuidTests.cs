...
public class MockTypeNullableGuidTests
{
    ...
    {
        var actual = Dm.NullableGuids().NullableProbability((Percentage)1);
    ...
    {
        var actual = Dm.NullableGuids().NullableProbability((Percentage)0).ToList();
    ...
    {
        var actual = Dm.NullableGuids().NullableProbability((Percentage)100).ToList();
    ...
    public void When_NullableGuidsNullableProbabilityAndToList_With_NullablePercentage_And_Size_Returns_ExpectedNullCount(int nullablePercentage, int size)
    {
        ...
        var actual = Dm.NullableGuids().NullableProbability((Percentage)nullablePercentage).ToList(size);
