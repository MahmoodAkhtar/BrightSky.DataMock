...
internal record MockTypeNullableGuidFixed : 
    ...
    IMockTypeEmptyNonEmptyProbability<Guid?, MockTypeNullableGuidFixed>
{
    ...
    public MockTypeNullableGuidFixed(Guid fix) => (_fix, _fixState) = (fix, true);
