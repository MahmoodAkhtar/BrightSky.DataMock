...
public record MockTypeNullableFloat : IMockType<float?>, IMockTypeRange<float?, float, float, MockTypeNullableFloat>, IMockTypeNullableProbability<float, MockTypeNullableFloat>
{
