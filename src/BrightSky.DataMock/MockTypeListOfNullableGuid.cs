...
internal record MockTypeListOfNullableGuid : 
    IMockType<List<Guid?>>,
    IMockTypeNullableProbability<List<Guid?>, MockTypeListOfNullableGuid>,
    IMockTypeEmptyNonEmptyProbability<List<Guid?>, MockTypeListOfNullableGuid>
{
    private bool _nullableState;
    private bool _fixState;
    private bool _emptyState;
    
    private readonly Guid? _fix;

    public MockTypeListOfNullableGuid() { }

    public MockTypeListOfNullableGuid(Guid fix) => (_fix, _fixState) = (fix, true);

    public List<Guid?> Get()
        => _fix.HasValue
        ? new MockTypeNullableGuidFixed(_fix.Value)
    ...
    public MockTypeListOfNullableGuid NullableProbability(Percentage nullablePercentage)
    {
    ...
    public MockTypeListOfNullableGuid NonEmptyProbability(Percentage nonEmptyPercentage)
    {
    ...
    public MockTypeListOfNullableGuid EmptyProbability(Percentage emptyPercentage)
    {
    ...
    private void AdjustPercentages()
    {
        ...
        */
        ...
        {
            { () => !_nullableState && !_fixState && !_emptyState, Adjustment.Case1 },
            { () => _nullableState  && !_fixState && !_emptyState, () => Adjustment.Case2(NullablePercentage) },
            { () => !_nullableState && _fixState  && !_emptyState, () => Adjustment.Case3(NonEmptyPercentage) },
            { () => !_nullableState && !_fixState && _emptyState,  () => Adjustment.Case4(EmptyPercentage) },
            { () => _nullableState  && _fixState  && !_emptyState, () => Adjustment.Case5(NullablePercentage, NonEmptyPercentage) },
            { () => _nullableState  && !_fixState && _emptyState,  () => Adjustment.Case6(NullablePercentage, EmptyPercentage) },
            { () => !_nullableState && _fixState  && _emptyState,  () => Adjustment.Case7(NonEmptyPercentage, EmptyPercentage) },
            { () => _nullableState  && _fixState  && _emptyState,  () => Adjustment.Case8(NullablePercentage, NonEmptyPercentage, EmptyPercentage) },
        };
